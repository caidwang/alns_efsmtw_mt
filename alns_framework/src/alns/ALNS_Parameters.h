...
public:
    ...
    double getWeightPenalty() const {
        return weightPenalty;
    }
    double getVolumePenalty() const {
        return volumePenalty;
    }
    double getTimeWinPenalty() const {
        return timeWinPenalty;
    }
    double getEnergyPenalty() const {
        return energyPenalty;
    }

    void setVolumePenalty(double v) {
        this->volumePenalty = v;
    }
    void setWeightPenalty(double w) {
        this->weightPenalty = w;
    }
    void setTimeWinPenalty(double t) {
        this->timeWinPenalty = t;
    }
    void setEnergyPenalty(double e) {
        this->energyPenalty = e;
    }
protected:
	...
	// Indicate how many times should the best answer be saved;
	int SaveFrequency;
